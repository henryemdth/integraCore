...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 min-w-[160px] max-w-[280px] items-center justify-between rounded bg-surface-container px-3 py-2 text-body-md text-foreground placeholder:text-muted-foreground border border-b-2 border-border border-b-transparent focus:outline-none focus:border-b-primary focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:truncate",
      className
    )}
    {...props}
  >
